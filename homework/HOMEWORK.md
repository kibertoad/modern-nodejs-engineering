...
* Implement a call from Pizza Ordering Service to Pizza Production Service for checking the ingredient availability, using the API contract. (https://github.com/lokalise/shared-ts-libs/tree/main/packages/app/backend-http-client)
